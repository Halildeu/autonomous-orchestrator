...
def _build_trend_best_practice_findings(
    *,
    ...
    from src.benchmark.eval_runner_trend_best_practice_findings import _build_trend_best_practice_findings_impl
    return _build_trend_best_practice_findings_impl(
...
def _build_integrity_compat_findings(
    *,
    workspace_root: Path,
    raw_ref: str,
    ...
    from src.benchmark.eval_runner_integrity_compat_findings import _build_integrity_compat_findings_impl
    return _build_integrity_compat_findings_impl(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
...
def _build_ai_ops_fit_findings(
    *,
    ...
    from src.benchmark.eval_runner_ai_ops_fit_findings import _build_ai_ops_fit_findings_impl
    return _build_ai_ops_fit_findings_impl(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
...
def _build_github_ops_release_findings(
    *,
    ...
    from src.benchmark.eval_runner_github_ops_release_findings import _build_github_ops_release_findings_impl
    return _build_github_ops_release_findings_impl(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
        requirements=requirements,
    )
...
def _build_integration_coherence_findings(
    *,
    ...
    from src.benchmark.eval_runner_integration_coherence_findings import _build_integration_coherence_findings_impl
    return _build_integration_coherence_findings_impl(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
...
def _build_operability_findings(
    *,
    ...
    from src.benchmark.eval_runner_operability_findings import _build_operability_findings_impl
    return _build_operability_findings_impl(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
...
def run_eval(*, workspace_root: Path, dry_run: bool) -> dict[str, Any]:
    ...
    trend_findings = _build_trend_best_practice_findings(
        ...
        evidence_paths={
            "assessment_eval_path": str(Path(".cache") / "index" / "assessment_eval.v1.json"),
    ...
    integrity_findings = _build_integrity_compat_findings(
        workspace_root=workspace_root,
        raw_ref=raw_ref,
        integrity_snapshot_ref=str(integrity_snapshot_ref),
        integrity_status=str(integrity_status) if integrity_status is not None else None,
    )
