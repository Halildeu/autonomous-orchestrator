...
from src.benchmark.eval_runner_runtime import (
    _build_maturity_document,
    _compute_context_health_lens,
    _ensure_catalogs,
    _lens_status,
    _load_policy_north_star_eval_lenses,
    _load_policy_north_star_integration_coherence,
    _load_policy_north_star_operability,
    _normalized_dimension_map,
    _safe_unit_float,
)
from src.shared.utils import write_json_atomic

def run_eval_impl(*, workspace_root: Path, dry_run: bool) -> dict[str, Any]:
