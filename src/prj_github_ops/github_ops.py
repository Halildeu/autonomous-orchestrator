...
def _run_pr_open_job(
    ...
    from src.prj_github_ops.github_ops_pr_open_job import _run_pr_open_job_impl

    _run_pr_open_job_impl(
        rc_path=rc_path,
...
def _run_release_create_job(
    ...
    from src.prj_github_ops.github_ops_release_create_job import _run_release_create_job_impl

    _run_release_create_job_impl(
        rc_path=rc_path,
        kind=kind,
        token_env=token_env,
        auth_mode=auth_mode,
...
def start_github_ops_job(
    *,
    ...
    from src.prj_github_ops.github_ops_start_job import start_github_ops_job_impl

    return start_github_ops_job_impl(
        workspace_root=workspace_root,
        kind=kind,
        dry_run=dry_run,
        request=request,
