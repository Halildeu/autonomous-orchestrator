...
- [0) Sistem Anayasası](#0-sistem-anayasası-başlamadan-kilitlenecek-kurallar)
- [Faz-0: Guardrail-First Starter Kit](#faz-0-guardrail-first-starter-kit-schema--security--ethics--bias--data--intent)
- [Faz-0.25: Uygulama Disiplini](#faz-025-uygulama-disiplini-wwv--workshop--day-1-ops-should)
- [Faz-0.5: Risk Scoring + HITL](#faz-05-risk-scoring--hitl-approval)
- [Faz-1: SSOT + Idempotency + Ledger](#faz-1-ssot--idempotency--side-effect-ledger--progressive-autonomy)
- [Faz-1.5: Governor + Cost Control](#faz-15-governor--cost-control--graceful-degradation--hot-fix-override)
- [Faz-2: Evidence + Provenance + Compliance](#faz-2-evidence--provenance--compliance--artifact-store--observability--gc)
- [Faz-3: Discovery + Cost-aware Routing](#faz-3-discovery--cost-aware-routing--autoscaling)
- [Faz-3.5: Dual-Run & Geçiş Yönetimi](#faz-35-dual-run--geçiş-yönetimi)
- [Faz-4: Workflow Orchestrator (DAG)](#faz-4-workflow-orchestrator-dag--suspendresume--konsol--dlq-must)
- [Faz-5: Executor (Sandbox) + Context Engine](#faz-5-executor-sandbox--capability-enforcement--gpuvirtualization--env-caching)
- [Faz-6: Security & Supply Chain](#faz-6-security--supply-chain--multi-tenant-fairnessquota--finops--data-poisoning)
- [Faz-7: AI Testing + Evals + Feedback](#faz-7-ai-testing--evals--shadow-mode--feedback--governor-öğrenmesi)
- [Faz-8: Ürünleştirme](#faz-8-ürünleştirme-ui--sdk--marketplace)
- [Faz-9: Kurumsal Ölçek](#faz-9-kurumsal-ölçek-sla-dr-ha-billing-sürdürülebilirlik)
- [Kırmızı Bayraklar](#kırmızı-bayraklar)
- [Başlama Stratejisi](#başlama-stratejisi-son-karar)
