...
- Capability: Governance Board Capability v1 is ACTIVE for the core repo under release channel 0.3.0-rc.1.
...
- Policies: policies/policy_github_ops.v1.json, policies/policy_board_governance.v1.json
