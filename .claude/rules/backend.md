...
- Auth architecture: Keycloak = login only, ALL authorization via OpenFGA (D-001, D-003)
- No auth logic in application code — delegate to OpenFGA middleware (permission-service is legacy, D-002)
